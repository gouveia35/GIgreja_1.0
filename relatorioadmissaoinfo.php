...
$RelatorioAdmissao = NULL;

//
// Table class for RelatorioAdmissao
//
class cRelatorioAdmissao extends cTable {
	var $Nome;
	var $Sexo;
	var $EstadoCivil;
	var $Tipo_Admissao;
	...
	function __construct() {
		...
		$this->TableVar = 'RelatorioAdmissao';
		$this->TableName = 'RelatorioAdmissao';
		...
		// Nome
		$this->Nome = new cField('RelatorioAdmissao', 'RelatorioAdmissao', 'x_Nome', 'Nome', 'membro.Nome', 'membro.Nome', 200, -1, FALSE, 'membro.Nome', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nome'] = &$this->Nome;

		// Sexo
		$this->Sexo = new cField('RelatorioAdmissao', 'RelatorioAdmissao', 'x_Sexo', 'Sexo', 'membro.Sexo', 'membro.Sexo', 202, -1, FALSE, 'membro.Sexo', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sexo'] = &$this->Sexo;

		// EstadoCivil
		$this->EstadoCivil = new cField('RelatorioAdmissao', 'RelatorioAdmissao', 'x_EstadoCivil', 'EstadoCivil', 'membro.EstadoCivil', 'membro.EstadoCivil', 202, -1, FALSE, 'membro.EstadoCivil', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['EstadoCivil'] = &$this->EstadoCivil;

		// Tipo_Admissao
		$this->Tipo_Admissao = new cField('RelatorioAdmissao', 'RelatorioAdmissao', 'x_Tipo_Admissao', 'Tipo_Admissao', 'membro.Tipo_Admissao', 'membro.Tipo_Admissao', 16, -1, FALSE, 'membro.Tipo_Admissao', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tipo_Admissao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Tipo_Admissao'] = &$this->Tipo_Admissao;

		// Admissao
		$this->Admissao = new cField('RelatorioAdmissao', 'RelatorioAdmissao', 'x_Admissao', 'Admissao', 'membro.Admissao', 'DATE_FORMAT(membro.Admissao, \'%d/%m/%Y\')', 133, 7, FALSE, 'membro.Admissao', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlSelect() { // Select
		return ($this->_SqlSelect <> "") ? $this->_SqlSelect : "SELECT membro.Nome, membro.Sexo, membro.EstadoCivil, membro.Tipo_Admissao, membro.Admissao FROM " . $this->getSqlFrom();
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "membro.Admissao asc";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "relatorioadmissaolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("relatorioadmissaoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("relatorioadmissaoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "relatorioadmissaoadd.php?" . $this->UrlParm($parm);
		else
			return "relatorioadmissaoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("relatorioadmissaoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("relatorioadmissaoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("relatorioadmissaodelete.php", $this->UrlParm());
	}
