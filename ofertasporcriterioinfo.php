...
$ofertasporcriterio = NULL;

//
// Table class for ofertasporcriterio
//
class cofertasporcriterio extends cTable {
	var $Id;
	var $id_discipulo;
	var $Mes;
	var $Tipo;
	...
	function __construct() {
		...
		$this->TableVar = 'ofertasporcriterio';
		$this->TableName = 'ofertasporcriterio';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// Id
		$this->Id = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// id_discipulo
		$this->id_discipulo = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_id_discipulo', 'id_discipulo', '`id_discipulo`', '`id_discipulo`', 3, -1, FALSE, '`id_discipulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_discipulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_discipulo'] = &$this->id_discipulo;

		// Mes
		$this->Mes = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Mes', 'Mes', '`Mes`', '`Mes`', 20, -1, FALSE, '`Mes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Mes->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Mes'] = &$this->Mes;

		// Tipo
		$this->Tipo = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Tipo', 'Tipo', '`Tipo`', '`Tipo`', 16, -1, FALSE, '`Tipo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tipo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Tipo'] = &$this->Tipo;

		// Conta_Caixa
		$this->Conta_Caixa = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Conta_Caixa', 'Conta_Caixa', '`Conta_Caixa`', '`Conta_Caixa`', 3, -1, FALSE, '`Conta_Caixa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Conta_Caixa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Conta_Caixa'] = &$this->Conta_Caixa;

		// Situacao
		$this->Situacao = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Situacao', 'Situacao', '`Situacao`', '`Situacao`', 16, -1, FALSE, '`Situacao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Situacao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Situacao'] = &$this->Situacao;

		// Descricao
		$this->Descricao = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Descricao', 'Descricao', '`Descricao`', '`Descricao`', 200, -1, FALSE, '`Descricao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Descricao'] = &$this->Descricao;

		// Receitas
		$this->Receitas = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Receitas', 'Receitas', '`Receitas`', '`Receitas`', 131, -1, FALSE, '`Receitas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Receitas->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Receitas'] = &$this->Receitas;

		// FormaPagto
		$this->FormaPagto = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_FormaPagto', 'FormaPagto', '`FormaPagto`', '`FormaPagto`', 16, -1, FALSE, '`FormaPagto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->FormaPagto->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FormaPagto'] = &$this->FormaPagto;

		// Dt_Lancamento
		$this->Dt_Lancamento = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Dt_Lancamento', 'Dt_Lancamento', '`Dt_Lancamento`', 'DATE_FORMAT(`Dt_Lancamento`, \'%d/%m/%Y\')', 133, 7, FALSE, '`Dt_Lancamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Vencimento
		$this->Vencimento = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Vencimento', 'Vencimento', '`Vencimento`', 'DATE_FORMAT(`Vencimento`, \'%d/%m/%Y\')', 133, 7, FALSE, '`Vencimento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Vencimento->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Vencimento'] = &$this->Vencimento;

		// Centro_de_Custo
		$this->Centro_de_Custo = new cField('ofertasporcriterio', 'ofertasporcriterio', 'x_Centro_de_Custo', 'Centro_de_Custo', '`Centro_de_Custo`', '`Centro_de_Custo`', 3, -1, FALSE, '`Centro_de_Custo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ofertasporcriterio`";
	}
	...
	// Update Table
	var $UpdateTable = "`ofertasporcriterio`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ofertasporcriteriolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("ofertasporcriterioview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("ofertasporcriterioview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "ofertasporcriterioadd.php?" . $this->UrlParm($parm);
		else
			return "ofertasporcriterioadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("ofertasporcriterioedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("ofertasporcriterioadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ofertasporcriteriodelete.php", $this->UrlParm());
	}
