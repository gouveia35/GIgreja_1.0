...
class cusuarios_list extends cusuarios {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->u->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->u->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->u->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'>";
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-warning ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fusuarioslistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
	...
	function RenderRow() {
		...
		$this->u->CellCssStyle = "white-space: nowrap;";
...
fusuarioslist.Lists["x_Level"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};

// Form object for search
var fusuarioslistsrch = new ew_Form("fusuarioslistsrch");

// Init search panel as collapsed
if (fusuarioslistsrch) fusuarioslistsrch.InitSearchPanel = true;
</script>
<script type="text/javascript">
...
<?php $SearchPanelClass = ($usuarios_list->SearchWhere <> "") ? " in" : ""; ?>
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($usuarios_list->BasicSearch->getKeyword()) ?>">
...
<?php if ($usuarios->Nome->Visible) { // Nome ?>
	<?php if ($usuarios->SortUrl($usuarios->Nome) == "") { ?>
		<th data-name="Nome"><div id="elh_usuarios_Nome" class="usuarios_Nome"><div class="ewTableHeaderCaption"><?php echo $usuarios->Nome->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Nome"><div><div id="elh_usuarios_Nome" class="usuarios_Nome">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->Nome->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->Nome->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->Nome->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->_login->Visible) { // login ?>
	<?php if ($usuarios->SortUrl($usuarios->_login) == "") { ?>
		<th data-name="_login"><div id="elh_usuarios__login" class="usuarios__login"><div class="ewTableHeaderCaption"><?php echo $usuarios->_login->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_login"><div><div id="elh_usuarios__login" class="usuarios__login">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->_login->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->_login->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->_login->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->senha->Visible) { // senha ?>
	<?php if ($usuarios->SortUrl($usuarios->senha) == "") { ?>
		<th data-name="senha"><div id="elh_usuarios_senha" class="usuarios_senha"><div class="ewTableHeaderCaption"><?php echo $usuarios->senha->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="senha"><div><div id="elh_usuarios_senha" class="usuarios_senha">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->senha->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->senha->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->senha->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->_email->Visible) { // email ?>
	...
	<?php } else { ?>
		<th data-name="_email"><div><div id="elh_usuarios__email" class="usuarios__email">
...
<?php if ($usuarios->Level->Visible) { // Level ?>
	<?php if ($usuarios->SortUrl($usuarios->Level) == "") { ?>
		<th data-name="Level"><div id="elh_usuarios_Level" class="usuarios_Level"><div class="ewTableHeaderCaption"><?php echo $usuarios->Level->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Level"><div><div id="elh_usuarios_Level" class="usuarios_Level">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->Level->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->Level->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->Level->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($usuarios->Nome->Visible) { // Nome ?>
		<td data-name="Nome"<?php echo $usuarios->Nome->CellAttributes() ?>>
<span<?php echo $usuarios->Nome->ViewAttributes() ?>>
<?php echo $usuarios->Nome->ListViewValue() ?></span>
<a id="<?php echo $usuarios_list->PageObjName . "_row_" . $usuarios_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($usuarios->_login->Visible) { // login ?>
		<td data-name="_login"<?php echo $usuarios->_login->CellAttributes() ?>>
<span<?php echo $usuarios->_login->ViewAttributes() ?>>
<?php echo $usuarios->_login->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($usuarios->senha->Visible) { // senha ?>
		<td data-name="senha"<?php echo $usuarios->senha->CellAttributes() ?>>
<span<?php echo $usuarios->senha->ViewAttributes() ?>>
<?php echo $usuarios->senha->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($usuarios->_email->Visible) { // email ?>
...
<?php echo $usuarios->_email->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuarios->Level->Visible) { // Level ?>
		<td data-name="Level"<?php echo $usuarios->Level->CellAttributes() ?>>
<span<?php echo $usuarios->Level->ViewAttributes() ?>>
<?php echo $usuarios->Level->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
