...
$print_transferencia = NULL;

//
// Table class for print_transferencia
//
class cprint_transferencia extends cTable {
	var $Id_membro;
	var $Nome;
	var $Sexo;
	var $Nacionalidade;
	...
	function __construct() {
		...
		$this->TableVar = 'print_transferencia';
		$this->TableName = 'print_transferencia';
		...
		// Id_membro
		$this->Id_membro = new cField('print_transferencia', 'print_transferencia', 'x_Id_membro', 'Id_membro', 'membro.Id_membro', 'membro.Id_membro', 3, -1, FALSE, 'membro.Id_membro', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_membro->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_membro'] = &$this->Id_membro;

		// Nome
		$this->Nome = new cField('print_transferencia', 'print_transferencia', 'x_Nome', 'Nome', 'membro.Nome', 'membro.Nome', 200, -1, FALSE, 'membro.Nome', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nome'] = &$this->Nome;

		// Sexo
		$this->Sexo = new cField('print_transferencia', 'print_transferencia', 'x_Sexo', 'Sexo', 'membro.Sexo', 'membro.Sexo', 202, -1, FALSE, 'membro.Sexo', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sexo'] = &$this->Sexo;

		// Nacionalidade
		$this->Nacionalidade = new cField('print_transferencia', 'print_transferencia', 'x_Nacionalidade', 'Nacionalidade', 'membro.Nacionalidade', 'membro.Nacionalidade', 200, -1, FALSE, 'membro.Nacionalidade', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nacionalidade'] = &$this->Nacionalidade;

		// EstadoCivil
		$this->EstadoCivil = new cField('print_transferencia', 'print_transferencia', 'x_EstadoCivil', 'EstadoCivil', 'membro.EstadoCivil', 'membro.EstadoCivil', 202, -1, FALSE, 'membro.EstadoCivil', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['EstadoCivil'] = &$this->EstadoCivil;

		// CPF
		$this->CPF = new cField('print_transferencia', 'print_transferencia', 'x_CPF', 'CPF', 'membro.CPF', 'membro.CPF', 200, -1, FALSE, 'membro.CPF', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CPF'] = &$this->CPF;

		// RG
		$this->RG = new cField('print_transferencia', 'print_transferencia', 'x_RG', 'RG', 'membro.RG', 'membro.RG', 200, -1, FALSE, 'membro.RG', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['RG'] = &$this->RG;

		// Matricula
		$this->Matricula = new cField('print_transferencia', 'print_transferencia', 'x_Matricula', 'Matricula', 'membro.Matricula', 'membro.Matricula', 200, -1, FALSE, 'membro.Matricula', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Matricula'] = &$this->Matricula;

		// Admissao
		$this->Admissao = new cField('print_transferencia', 'print_transferencia', 'x_Admissao', 'Admissao', 'membro.Admissao', 'DATE_FORMAT(membro.Admissao, \'%d/%m/%Y\')', 133, 7, FALSE, 'membro.Admissao', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Admissao->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Admissao'] = &$this->Admissao;

		// CargoMinisterial
		$this->CargoMinisterial = new cField('print_transferencia', 'print_transferencia', 'x_CargoMinisterial', 'CargoMinisterial', 'cargosministeriais.Cargo_Ministerial', 'cargosministeriais.Cargo_Ministerial', 200, -1, FALSE, 'cargosministeriais.Cargo_Ministerial', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CargoMinisterial'] = &$this->CargoMinisterial;

		// Da_Igreja
		$this->Da_Igreja = new cField('print_transferencia', 'print_transferencia', 'x_Da_Igreja', 'Da_Igreja', 'igrejas.Igreja', 'igrejas.Igreja', 200, -1, FALSE, 'igrejas.Igreja', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "print_transferencialist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("print_transferenciaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("print_transferenciaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "print_transferenciaadd.php?" . $this->UrlParm($parm);
		else
			return "print_transferenciaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("print_transferenciaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("print_transferenciaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("print_transferenciadelete.php", $this->UrlParm());
	}
