...
class cusuarios_view extends cusuarios {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["u"] <> "") {
			$this->RecKey["u"] = $_GET["u"];
			$KeyUrl .= "&amp;u=" . urlencode($this->RecKey["u"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["u"] <> "") {
				...
				$this->RecKey["u"] = $this->u->QueryStringValue;
			} else {
...
fusuariosview.Lists["x_Level"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($usuarios->Nome->Visible) { // Nome ?>
	<tr id="r_Nome">
		<td><span id="elh_usuarios_Nome"><?php echo $usuarios->Nome->FldCaption() ?></span></td>
		<td<?php echo $usuarios->Nome->CellAttributes() ?>>
<span id="el_usuarios_Nome" class="form-group">
<span<?php echo $usuarios->Nome->ViewAttributes() ?>>
<?php echo $usuarios->Nome->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->_login->Visible) { // login ?>
	<tr id="r__login">
		<td><span id="elh_usuarios__login"><?php echo $usuarios->_login->FldCaption() ?></span></td>
		<td<?php echo $usuarios->_login->CellAttributes() ?>>
<span id="el_usuarios__login" class="form-group">
<span<?php echo $usuarios->_login->ViewAttributes() ?>>
<?php echo $usuarios->_login->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->senha->Visible) { // senha ?>
	<tr id="r_senha">
		<td><span id="elh_usuarios_senha"><?php echo $usuarios->senha->FldCaption() ?></span></td>
		<td<?php echo $usuarios->senha->CellAttributes() ?>>
<span id="el_usuarios_senha" class="form-group">
<span<?php echo $usuarios->senha->ViewAttributes() ?>>
<?php echo $usuarios->senha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_usuarios__email" class="form-group">
...
<?php if ($usuarios->Level->Visible) { // Level ?>
	<tr id="r_Level">
		<td><span id="elh_usuarios_Level"><?php echo $usuarios->Level->FldCaption() ?></span></td>
		<td<?php echo $usuarios->Level->CellAttributes() ?>>
<span id="el_usuarios_Level" class="form-group">
<span<?php echo $usuarios->Level->ViewAttributes() ?>>
<?php echo $usuarios->Level->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
