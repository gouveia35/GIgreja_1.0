...
$RelatorioCasamento = NULL;

//
// Table class for RelatorioCasamento
//
class cRelatorioCasamento extends cTable {
	var $Nome;
	var $Sexo;
	var $EstadoCivil;
	var $Conjuge;
	...
	function __construct() {
		...
		$this->TableVar = 'RelatorioCasamento';
		$this->TableName = 'RelatorioCasamento';
		...
		// Nome
		$this->Nome = new cField('RelatorioCasamento', 'RelatorioCasamento', 'x_Nome', 'Nome', 'membro.Nome', 'membro.Nome', 200, -1, FALSE, 'membro.Nome', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nome'] = &$this->Nome;

		// Sexo
		$this->Sexo = new cField('RelatorioCasamento', 'RelatorioCasamento', 'x_Sexo', 'Sexo', 'membro.Sexo', 'membro.Sexo', 202, -1, FALSE, 'membro.Sexo', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sexo'] = &$this->Sexo;

		// EstadoCivil
		$this->EstadoCivil = new cField('RelatorioCasamento', 'RelatorioCasamento', 'x_EstadoCivil', 'EstadoCivil', 'membro.EstadoCivil', 'membro.EstadoCivil', 202, -1, FALSE, 'membro.EstadoCivil', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['EstadoCivil'] = &$this->EstadoCivil;

		// Conjuge
		$this->Conjuge = new cField('RelatorioCasamento', 'RelatorioCasamento', 'x_Conjuge', 'Conjuge', 'membro.Conjuge', 'membro.Conjuge', 200, -1, FALSE, 'membro.Conjuge', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Conjuge'] = &$this->Conjuge;

		// Data_Casamento
		$this->Data_Casamento = new cField('RelatorioCasamento', 'RelatorioCasamento', 'x_Data_Casamento', 'Data_Casamento', 'membro.Data_Casamento', 'DATE_FORMAT(membro.Data_Casamento, \'%d/%m/%Y\')', 133, 7, FALSE, 'membro.Data_Casamento', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlSelect() { // Select
		return ($this->_SqlSelect <> "") ? $this->_SqlSelect : "SELECT membro.Nome, membro.Sexo, membro.EstadoCivil, membro.Conjuge, membro.Data_Casamento FROM " . $this->getSqlFrom();
	}
	...
	function getSqlWhere() { // Where
		$sWhere = ($this->_SqlWhere <> "") ? $this->_SqlWhere : "membro.EstadoCivil = 'Casado(a)'";
		$this->TableFilter = "";
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "membro.Data_Casamento";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "relatoriocasamentolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("relatoriocasamentoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("relatoriocasamentoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "relatoriocasamentoadd.php?" . $this->UrlParm($parm);
		else
			return "relatoriocasamentoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("relatoriocasamentoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("relatoriocasamentoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("relatoriocasamentodelete.php", $this->UrlParm());
	}
