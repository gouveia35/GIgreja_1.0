...
//
// Table class for dizimos
//
class cdizimos extends cTable {
	var $Id;
	var $id_discipulo;
	var $Tipo;
	var $Situacao;
	...
	function __construct() {
		...
		$this->TableVar = 'dizimos';
		$this->TableName = 'dizimos';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// Id
		$this->Id = new cField('dizimos', 'dizimos', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// id_discipulo
		$this->id_discipulo = new cField('dizimos', 'dizimos', 'x_id_discipulo', 'id_discipulo', '`id_discipulo`', '`id_discipulo`', 3, -1, FALSE, '`id_discipulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_discipulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_discipulo'] = &$this->id_discipulo;

		// Tipo
		$this->Tipo = new cField('dizimos', 'dizimos', 'x_Tipo', 'Tipo', '`Tipo`', '`Tipo`', 16, -1, FALSE, '`Tipo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tipo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Tipo'] = &$this->Tipo;

		// Situacao
		$this->Situacao = new cField('dizimos', 'dizimos', 'x_Situacao', 'Situacao', '`Situacao`', '`Situacao`', 16, -1, FALSE, '`Situacao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Situacao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Situacao'] = &$this->Situacao;

		// Conta_Caixa
		$this->Conta_Caixa = new cField('dizimos', 'dizimos', 'x_Conta_Caixa', 'Conta_Caixa', '`Conta_Caixa`', '`Conta_Caixa`', 3, -1, FALSE, '`Conta_Caixa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Conta_Caixa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Conta_Caixa'] = &$this->Conta_Caixa;

		// Descricao
		$this->Descricao = new cField('dizimos', 'dizimos', 'x_Descricao', 'Descricao', '`Descricao`', '`Descricao`', 200, -1, FALSE, '`Descricao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Descricao'] = &$this->Descricao;

		// Receitas
		$this->Receitas = new cField('dizimos', 'dizimos', 'x_Receitas', 'Receitas', '`Receitas`', '`Receitas`', 131, -1, FALSE, '`Receitas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Receitas->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Receitas'] = &$this->Receitas;

		// FormaPagto
		$this->FormaPagto = new cField('dizimos', 'dizimos', 'x_FormaPagto', 'FormaPagto', '`FormaPagto`', '`FormaPagto`', 16, -1, FALSE, '`FormaPagto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->FormaPagto->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FormaPagto'] = &$this->FormaPagto;

		// Dt_Lancamento
		$this->Dt_Lancamento = new cField('dizimos', 'dizimos', 'x_Dt_Lancamento', 'Dt_Lancamento', '`Dt_Lancamento`', 'DATE_FORMAT(`Dt_Lancamento`, \'%d/%m/%Y\')', 133, 7, FALSE, '`Dt_Lancamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Vencimento
		$this->Vencimento = new cField('dizimos', 'dizimos', 'x_Vencimento', 'Vencimento', '`Vencimento`', 'DATE_FORMAT(`Vencimento`, \'%d/%m/%Y\')', 133, 7, FALSE, '`Vencimento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Vencimento->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Vencimento'] = &$this->Vencimento;

		// Centro_de_Custo
		$this->Centro_de_Custo = new cField('dizimos', 'dizimos', 'x_Centro_de_Custo', 'Centro_de_Custo', '`Centro_de_Custo`', '`Centro_de_Custo`', 3, -1, FALSE, '`Centro_de_Custo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "membro") {
			if ($this->id_discipulo->getSessionValue() <> "")
				$sMasterFilter .= "`Id_membro`=" . ew_QuotedValue($this->id_discipulo->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "membro") {
			if ($this->id_discipulo->getSessionValue() <> "")
				$sDetailFilter .= "`id_discipulo`=" . ew_QuotedValue($this->id_discipulo->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_membro() {
		return "`Id_membro`=@Id_membro@";
	}

	// Detail filter
	function SqlDetailFilter_membro() {
		return "`id_discipulo`=@id_discipulo@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`dizimos`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("dizimosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("dizimosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "dizimosadd.php?" . $this->UrlParm($parm);
		else
			return "dizimosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("dizimosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("dizimosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("dizimosdelete.php", $this->UrlParm());
	}
