...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	<?php if ($userlevels->SortUrl($userlevels->userlevelname) == "") { ?>
		<th data-name="userlevelname"><div id="elh_userlevels_userlevelname" class="userlevels_userlevelname"><div class="ewTableHeaderCaption" style="width: 250px;"><?php echo $userlevels->userlevelname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="userlevelname"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevels->SortUrl($userlevels->userlevelname) ?>',2);"><div id="elh_userlevels_userlevelname" class="userlevels_userlevelname">
			<div class="ewTableHeaderBtn" style="width: 250px;"><span class="ewTableHeaderCaption"><?php echo $userlevels->userlevelname->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($userlevels->userlevelname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($userlevels->userlevelname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
