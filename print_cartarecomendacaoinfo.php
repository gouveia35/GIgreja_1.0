...
$print_cartarecomendacao = NULL;

//
// Table class for print_cartarecomendacao
//
class cprint_cartarecomendacao extends cTable {
	var $Id_membro;
	var $Matricula;
	var $Nome;
	var $Sexo;
	...
	function __construct() {
		...
		$this->TableVar = 'print_cartarecomendacao';
		$this->TableName = 'print_cartarecomendacao';
		...
		// Id_membro
		$this->Id_membro = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_Id_membro', 'Id_membro', 'membro.Id_membro', 'membro.Id_membro', 3, -1, FALSE, 'membro.Id_membro', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_membro->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_membro'] = &$this->Id_membro;

		// Matricula
		$this->Matricula = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_Matricula', 'Matricula', 'membro.Matricula', 'membro.Matricula', 200, -1, FALSE, 'membro.Matricula', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Matricula'] = &$this->Matricula;

		// Nome
		$this->Nome = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_Nome', 'Nome', 'membro.Nome', 'membro.Nome', 200, -1, FALSE, 'membro.Nome', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nome'] = &$this->Nome;

		// Sexo
		$this->Sexo = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_Sexo', 'Sexo', 'membro.Sexo', 'membro.Sexo', 202, -1, FALSE, 'membro.Sexo', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sexo'] = &$this->Sexo;

		// Nacionalidade
		$this->Nacionalidade = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_Nacionalidade', 'Nacionalidade', 'membro.Nacionalidade', 'membro.Nacionalidade', 200, -1, FALSE, 'membro.Nacionalidade', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nacionalidade'] = &$this->Nacionalidade;

		// EstadoCivil
		$this->EstadoCivil = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_EstadoCivil', 'EstadoCivil', 'membro.EstadoCivil', 'membro.EstadoCivil', 202, -1, FALSE, 'membro.EstadoCivil', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['EstadoCivil'] = &$this->EstadoCivil;

		// CPF
		$this->CPF = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_CPF', 'CPF', 'membro.CPF', 'membro.CPF', 200, -1, FALSE, 'membro.CPF', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CPF'] = &$this->CPF;

		// Da_Igreja
		$this->Da_Igreja = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_Da_Igreja', 'Da_Igreja', 'igrejas.Igreja', 'igrejas.Igreja', 200, -1, FALSE, 'igrejas.Igreja', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Da_Igreja->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Da_Igreja'] = &$this->Da_Igreja;

		// CargoMinisterial
		$this->CargoMinisterial = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_CargoMinisterial', 'CargoMinisterial', 'cargosministeriais.Cargo_Ministerial', 'cargosministeriais.Cargo_Ministerial', 200, -1, FALSE, 'cargosministeriais.Cargo_Ministerial', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// RG
		$this->RG = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_RG', 'RG', 'membro.RG', 'membro.RG', 200, -1, FALSE, 'membro.RG', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['RG'] = &$this->RG;

		// Admissao
		$this->Admissao = new cField('print_cartarecomendacao', 'print_cartarecomendacao', 'x_Admissao', 'Admissao', 'membro.Admissao', 'DATE_FORMAT(membro.Admissao, \'%d/%m/%Y\')', 133, 7, FALSE, 'membro.Admissao', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlKeyFilter() {
		return "membro.Id_membro = @Id_membro@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "print_cartarecomendacaolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("print_cartarecomendacaoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("print_cartarecomendacaoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "print_cartarecomendacaoadd.php?" . $this->UrlParm($parm);
		else
			return "print_cartarecomendacaoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("print_cartarecomendacaoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("print_cartarecomendacaoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("print_cartarecomendacaodelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$sSqlWrk .= " ORDER BY `Nome` ASC";
			$rswrk = $conn->Execute($sSqlWrk);
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->Id_membro->EditValue = $rswrk->fields('DispFld');
				$this->Id_membro->EditValue .= ew_ValueSeparator(1,$this->Id_membro) . $rswrk->fields('Disp2Fld');
				$rswrk->Close();
			} else {
				$this->Id_membro->EditValue = $this->Id_membro->CurrentValue;
			}
		} else {
			$this->Id_membro->EditValue = NULL;
		}
		$this->Id_membro->ViewCustomAttributes = "";
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->Id_membro->Exportable) $Doc->ExportCaption($this->Id_membro);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->Id_membro->Exportable) $Doc->ExportField($this->Id_membro);
