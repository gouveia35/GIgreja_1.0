...
$print_cartaexclusao = NULL;

//
// Table class for print_cartaexclusao
//
class cprint_cartaexclusao extends cTable {
	var $Id_membro;
	var $Nome;
	var $Sexo;
	var $Nacionalidade;
	...
	function __construct() {
		...
		$this->TableVar = 'print_cartaexclusao';
		$this->TableName = 'print_cartaexclusao';
		...
		// Id_membro
		$this->Id_membro = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_Id_membro', 'Id_membro', 'membro.Id_membro', 'membro.Id_membro', 3, -1, FALSE, 'membro.Id_membro', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_membro->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_membro'] = &$this->Id_membro;

		// Nome
		$this->Nome = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_Nome', 'Nome', 'membro.Nome', 'membro.Nome', 200, -1, FALSE, 'membro.Nome', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nome'] = &$this->Nome;

		// Sexo
		$this->Sexo = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_Sexo', 'Sexo', 'membro.Sexo', 'membro.Sexo', 202, -1, FALSE, 'membro.Sexo', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sexo'] = &$this->Sexo;

		// Nacionalidade
		$this->Nacionalidade = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_Nacionalidade', 'Nacionalidade', 'membro.Nacionalidade', 'membro.Nacionalidade', 200, -1, FALSE, 'membro.Nacionalidade', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nacionalidade'] = &$this->Nacionalidade;

		// EstadoCivil
		$this->EstadoCivil = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_EstadoCivil', 'EstadoCivil', 'membro.EstadoCivil', 'membro.EstadoCivil', 202, -1, FALSE, 'membro.EstadoCivil', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['EstadoCivil'] = &$this->EstadoCivil;

		// CPF
		$this->CPF = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_CPF', 'CPF', 'membro.CPF', 'membro.CPF', 200, -1, FALSE, 'membro.CPF', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CPF'] = &$this->CPF;

		// RG
		$this->RG = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_RG', 'RG', 'membro.RG', 'membro.RG', 200, -1, FALSE, 'membro.RG', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['RG'] = &$this->RG;

		// Matricula
		$this->Matricula = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_Matricula', 'Matricula', 'membro.Matricula', 'membro.Matricula', 200, -1, FALSE, 'membro.Matricula', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Matricula'] = &$this->Matricula;

		// Admissao
		$this->Admissao = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_Admissao', 'Admissao', 'membro.Admissao', 'DATE_FORMAT(membro.Admissao, \'%d/%m/%Y\')', 133, 7, FALSE, 'membro.Admissao', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Admissao->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Admissao'] = &$this->Admissao;

		// CargoMinisterial
		$this->CargoMinisterial = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_CargoMinisterial', 'CargoMinisterial', 'cargosministeriais.Cargo_Ministerial', 'cargosministeriais.Cargo_Ministerial', 200, -1, FALSE, 'cargosministeriais.Cargo_Ministerial', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CargoMinisterial'] = &$this->CargoMinisterial;

		// Da_Igreja
		$this->Da_Igreja = new cField('print_cartaexclusao', 'print_cartaexclusao', 'x_Da_Igreja', 'Da_Igreja', 'igrejas.Igreja', 'igrejas.Igreja', 200, -1, FALSE, 'igrejas.Igreja', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "print_cartaexclusaolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("print_cartaexclusaoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("print_cartaexclusaoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "print_cartaexclusaoadd.php?" . $this->UrlParm($parm);
		else
			return "print_cartaexclusaoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("print_cartaexclusaoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("print_cartaexclusaoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("print_cartaexclusaodelete.php", $this->UrlParm());
	}
